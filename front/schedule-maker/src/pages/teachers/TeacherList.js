import { Button,Checkbox,FormControlLabel,FormGroup,Grid,Paper,Table,TableBody,TableCell,TableContainer,
    TableFooter,TableHead,TablePagination,TableRow,TextField,
  } from "@mui/material";
    ...
    const handleSearch = (event) => {
      if (event.length === 0) {
        ...
        const filtered = teachers.filter((teacher) => {
          const teacherName = teacher.name.toLowerCase();  //iki cia perziureta jjjj
          const subjectDescription = teacher.description.toLowerCase();
          return (
