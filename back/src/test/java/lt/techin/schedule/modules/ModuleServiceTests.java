...
public class ModuleServiceTests {
    ...
    public void testAddUniqueModuleWithUniqueName() {
        Module module = new Module(1L, "10", "Module",
    ...
    public void testAddUniqueModuleWithDuplicateName() {
        Module module1 = new Module(1L, "100", "Module1",
                LocalDateTime.now(), LocalDateTime.now(), false);
        Module module2 = new Module(2L, "100", "Module2",
    ...
    public void testGetShiftByID() {
        Module module = new Module(1L, "100", "Module1",
                LocalDateTime.now(), LocalDateTime.now(), false);
    ...
    public void testModifyModuleWithUniqueNumber() {
        Module module1 = new Module(1L, "100", "Module1",
                LocalDateTime.now(), LocalDateTime.now(), false);
        Module module2 = new Module(2L, "1000", "Module2",
                LocalDateTime.now(), LocalDateTime.now(), true);
        Module module3 = new Module(2L, "1000", "Module3",
                LocalDateTime.now(), LocalDateTime.now(), true);
    ...
    public void testModifyModuleWithDuplicateNumber() {
        Module module1 = new Module(1L, "1000", "Module1",
                LocalDateTime.now(), LocalDateTime.now(), false);
        Module module2 = new Module(2L, "100", "Module2",
                LocalDateTime.now(), LocalDateTime.now(), true);
        Module module3 = new Module(2L, "1000", "Module3",
